...
"${TOOLS_DIR}/run_firmware_profile.sh" "${FIRMWARE_DIR}" "${FIRMWARE_OUT}"
"${TOOLS_DIR}/run_real_blob_regression.sh" "${REAL_BLOB_DIR}" "${REAL_BLOB_OUT}"
"${TOOLS_DIR}/run_firmware_profile.sh" "${DEMO_DIR}" "${DEMO_OUT}"
"${TOOLS_DIR}/fetch_public_nvidia_mn103_samples.sh" "${PUBLIC_NVIDIA_DIR}"
"${TOOLS_DIR}/run_firmware_profile.sh" "${PUBLIC_NVIDIA_DIR}" "${PUBLIC_NVIDIA_OUT}"
"${TOOLS_DIR}/run_public_panasonic_gate_profile.sh" "${PUBLIC_PANASONIC_OUT}" "${PUBLIC_PANASONIC_DIR}"
